<div class="flex grow flex-col gap-y-5 overflow-y-auto lg:border-r lg:border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 px-6 pb-4">
        ...
        <ul role="list" class="flex flex-1 flex-col gap-y-7">
            <li>
                <ul role="list" class="-mx-2 space-y-1">
                    <li>
                        <x-admin.links.nav :href="route('admin.dashboard')" :active="request()->routeIs('admin.dashboard')">
            ...
            <!-- <li>
                <div class="text-xs font-semibold leading-6 text-gray-400 dark:text-gray-200">Reports</div>
